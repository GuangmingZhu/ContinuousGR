...
class Model(Container):
    ...
    for i in range(len(self.outputs)):
      ...
      for metric in output_metrics:
        if metric == 'accuracy' or metric == 'acc':
          ...
          # Three lines are Added by GuangmingZhu @ 2017-11-22 for gesture boundary detection
          elif self.loss_functions[i] == losses.balanced_squared_hinge:
            # case: balanced accuracy
            acc_fn = metrics_module.iou_accuracy
          else:
  ...
  def _standardize_user_data(self,
    ...
    #_check_array_lengths(x, y, sample_weights) #Deleted by zgm @ 2017-10-19
