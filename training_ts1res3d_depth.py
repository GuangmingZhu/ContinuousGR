...
dataset_name = 'congr_ts1res3d_depth'
training_datalist = './dataset_splits/ConGD/train_depth_list.txt'
testing_datalist = './dataset_splits/ConGD/valid_depth_list.txt'
model_prefix = '.'
weights_file = '%s/trained_models/ts1res3d/%s_weights.{epoch:02d}-{val_loss:.2f}.h5'%(model_prefix,dataset_name)
